...
<body>
 ...
 <form action="<?php echo e(route('cudratica.calcular')); ?>" method="POST" enctype="multipart/form-data">
...
<?php /**PATH C:\xampp\htdocs\larav3066446\resources\views\cuadratica.blade.php ENDPATH**/ ?>